...
format:
  revealjs: 
    ...
    scrollable: true
  pdf: 
    output-file: "schluppeck-05-handout.pdf"
    mainfont: "Atkinson Hyperlegible"
  html:
    css: styles.css
    mainfont: "Atkinson Hyperlegible"
    output-file: "schluppeck-05-handout.html"
...
![qr code](images/2025-26-qr-code.png)
...
-   demo analysis in `fsl` (quick walk-through)
:::
...
-   Details on [moodle (2025/26)](https://moodle.nottingham.ac.uk/course/section.php?id=1982033).
...
[Link to Install instructions](https://echo360.org.uk/public/media/cb45dbfd-de4a-4180-9700-bc8c48ddf6f3)
