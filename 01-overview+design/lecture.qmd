...
format:
  ...
  pptx: 
    output-file: "schluppeck-01-handout.pptx"
    mainfont: "Arial"
  pdf: 
  ...
  html:
    header-includes: |
      <link rel="stylesheet" media="screen"   href="https://fonts.googleapis.com/css2?family=Atkinson+Hyperlegible&display=swap" type="text/css"/>
...
-   Details on [moodle (2024/25)](https://moodle.nottingham.ac.uk/course/view.php?id=137637).
