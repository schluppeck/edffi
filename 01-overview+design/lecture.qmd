...
| week |            | Lecture                                               |
|------|------------|-------------------------------------------------------|
| 03   | Schluppeck | Overview, **fMRI & study design.**                    |
| 04   | Schürmann  | **Basic neuroanatomy.**                               |
| 05   | Dyke       | **Brain stimulation & study design.**                 |
| 06   | Cragg      | **Developmental neuroimaging.**                       |
| 07   | Schluppeck | **Vision + brain imaging.**                           |
| 08   | Schluppeck | **Q&A, experimental design, coursework.**             |
| 09   | v Heuven   | **Language.**                                         |
| 10   | Derrfuss   | **Cognitive control, attention, and working memory.** |
| 11   | Filik      | **Moral Cognition.**                                  |
| 12   | Schluppeck | **Perceptual decision making.** Q&A.                  |
:::
...
::: fragment
**Between-subjects designs are sometime unavoidable**a
...
## . {background="images/F1.large.jpg" background-size="contain"}

## TP {background="images/temporal-precision.png" background-size="contain"}
